...
<header>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Modulo 5 - Sesion 3 - Evaluation - Sesión iniciada con Sessions a nombre de
    ...
    <div class="row justify-content-center min-vh-100">
        <div class="col-md-6 ">
            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-4"> Estimado <%= session.getAttribute("nombre2")%> a ingresado ha su área personal <br>
                            utilizando Sessions.</h5>
                        <form action="./logoutServletConSessions" method="post">
                            <div class="d-grid">
